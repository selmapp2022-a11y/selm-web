...
export const IELTS_GT: ExamDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        { id: 'gt-r-01', level: 'A1', family: 'notice',
          content: 'STAFF ONLY. This door is for employees. Customers, please use the main entrance on Oak Street.',
          ...
          answer: 2, rationale: 'The notice restricts the door to employees; the longest options are the distractors.' },
        { id: 'gt-r-02', level: 'A2', family: 'correspondence',
          content: "Hi Sam, I can't make lunch on Tuesday after all - something came up at work. Could we move it to Thursday? Same place is fine. Sorry! - Alex",
          ...
          answer: 1, rationale: 'Alex proposes moving the day, not cancelling; the key is the shortest option.' },
        { id: 'gt-r-03', level: 'B1', family: 'informative',
          content: 'The city library now opens at 8 a.m. on weekdays, an hour earlier than before. Weekend hours are unchanged. The later closing time of 9 p.m., introduced last year, remains in place.',
          ...
          answer: 1, rationale: 'Only the weekday opening changed recently; the later closing was last year and weekends are unchanged.' },
        { id: 'gt-r-04', level: 'B2', family: 'argued',
          content: 'Supporters of the new bypass say it will cut traffic in the town centre. Critics counter that similar roads elsewhere simply filled with new cars within a few years, leaving the centre as congested as before. The council has promised a review after eighteen months.',
          ...
          answer: 1, rationale: 'The critics say new roads induce new traffic; the other options belong to supporters, the council, or misread the text.' },
        { id: 'gt-r-05', level: 'C1', family: 'informative',
          content: 'The report notes that remote work has raised productivity for tasks done alone, but adds a caveat: the same teams said that spontaneous problem-solving - the kind that once happened in a corridor - had become markedly rarer, and harder to replace with scheduled calls.',
          ...
          answer: 1, rationale: 'The caveat is about lost spontaneous collaboration; the last option is the uncaveated first point, and the longest option is false.' },
        { id: 'gt-r-06', level: 'C2', family: 'argued',
          content: 'One might, of course, applaud the ministry for finally publishing the figures - were it not that the figures cover only the years in which the policy happened to succeed, and stop precisely where the awkward questions begin.',
          ...
          answer: 1, rationale: 'The concessive "were it not that" signals irony; the surface praise (longest option) is undercut.' },
      ],
    },
  ],
};
