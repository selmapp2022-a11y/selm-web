  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        // ── added 2026-08-28 ──────────────────────────────────────────────
        //
        // Eighteen items filling every (family × level) coordinate of
        // compréhension écrite at B1 and B2 — the band NCLC 6 and 7 sit in,
        // and where §2.5 says candidates cluster.
        //
        // The planner printed the list: `consigne` existed only at A1,
        // `correspondance` only at A2–B1, `argumentatif` at two per level.
        // A B2 candidate working on correspondance had ZERO items. The bank
        // was authored as a difficulty ladder rather than a family × level
        // grid, so the families and the levels were correlated; these break
        // that correlation where it matters most.
        {
          id: "tcf-ce-40",
          level: "B1",
          content: "AVIS AUX LOCATAIRES — Travaux de plomberie. L'eau sera coupée du mardi 8 h au mardi 16 h. Les locataires du 3e et du 4e étage n'ont rien à faire. Ceux du 1er et du 2e doivent vider leur chauffe-eau avant lundi soir ; la marche à suivre est affichée dans la buanderie. Le concierge ne peut pas entrer chez vous en votre absence pour effectuer cette opération.",
          stem: "Vous habitez au 2e étage et vous serez absent lundi. Que devez-vous faire ?",
          options: ["Vider votre chauffe-eau avant de partir", "Prévenir le 3e et le 4e étage", "Laisser vos clés à la buanderie", "Attendre le concierge mardi matin"],
          answer: 0,
        ...
        },
        {
          id: "tcf-ce-43",
          level: "B1",
          content: "BIBLIOTHÈQUE — Prêt de livres. Vous pouvez emprunter huit documents pour trois semaines. Le renouvellement se fait par téléphone ou sur le site, une seule fois, et seulement si personne n'a réservé le document. Les nouveautés, signalées par une pastille rouge, ne se renouvellent jamais.",
        ...
        },
        {
          ...
          options: ["Pour reprocher à l'équipe son silence en réunion", "Pour recueillir des avis que la réunion n'a pas permis d'exprimer", "Pour fixer une nouvelle réunion avant vendredi", "Pour annoncer les nouveaux horaires d'été"],
          answer: 1,
        ...
        },
        {
          ...
          options: ["Demander une prolongation du délai de six mois", "Transmettre à nouveau le relevé de notes manquant", "Contester le constat d'incomplétude et rappeler le point de départ du délai", "Se plaindre du fonctionnement du service courrier"],
          answer: 2,
        ...
        },
        {
          ...
          options: ["Elle reproche à Nadia de ne penser qu'à l'argent", "Elle conseille à Nadia d'accepter le poste", "Elle refuse de donner son avis pour ne pas influencer Nadia", "Elle attire l'attention de Nadia sur ce que sa lettre ne dit pas"],
          answer: 3,
        ...
        },
        {
          ...
          options: ["Une explication sur l'échec de l'intervention", "Un rendez-vous un samedi pour la prochaine intervention", "Le remplacement immédiat du compteur", "Un dédommagement pour la demi-journée perdue"],
          answer: 1,
